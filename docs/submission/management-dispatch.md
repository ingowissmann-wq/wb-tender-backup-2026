...
Die Neueingabemaske unter `/admin/ausschreibungen/portalzugang-neueingabe` zeigt im freigegebenen Gesellschaftsbereich nur nicht entschlüsselbare Zugänge. Sie fragt ausschließlich neue Zugangsdaten ab. Der ursprüngliche verschlüsselte Datensatz bleibt erhalten; ein neuer Datensatz wird gespeichert, unmittelbar zurückgelesen und über eine unveränderliche Historie zugeordnet. Die 14 produktiven Altzugänge können erst nach tatsächlicher Neueingabe wieder verwendet werden.
