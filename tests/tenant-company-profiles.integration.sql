...
DO $$ BEGIN IF EXISTS(SELECT 1 FROM tenant_portal.company_profile_versions) OR EXISTS(SELECT 1 FROM tenant_portal.lot_assignment_versions) THEN RAISE EXCEPTION 'foreign_profile_visible'; END IF; END $$;
