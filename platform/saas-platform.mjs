...
export async function registerPendingTenant(client, input, { verificationPepper, now = new Date(), requestIp = "", userAgent = "" }) {
  ...
  if (!["AUTO_CARD","INVOICE_BANK_TRANSFER","INVOICE_BILLIE"].includes(billingPath)) throw Object.assign(new Error("billing_path_invalid"), { statusCode: 400 });
