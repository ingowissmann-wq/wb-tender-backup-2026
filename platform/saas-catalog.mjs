...
export const MODULE_CATALOG = Object.freeze([
  ...
  { key: MODULE_KEYS.CRM, slug: "crm", name: "WB CRM", description: "Tenant-owned prospect and customer accounts, contacts and audited sales stages.", category: "Customer", status: "TENANT_ACCOUNTS_CONTACTS", dependencies: [], availableInPlans: ["PROFESSIONAL", "ENTERPRISE"] },
  ...
  { key: MODULE_KEYS.FLOW, slug: "flow", name: "WB Flow", description: "Versioned company and lot tasks, required steps, responsibilities and sourced deadlines.", category: "Operations", status: "VERSIONED_TENANT_TASKS", dependencies: [], availableInPlans: ["NORMAL", "PROFESSIONAL", "ENTERPRISE"] },
