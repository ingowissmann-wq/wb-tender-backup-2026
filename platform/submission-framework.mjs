...
export const SUBMISSION_ADAPTER_METHODS=Object.freeze(["buildInternalPackage","validateInternalPackage","mapInternalPackage","planPortalStaging","planFinalHandoff","pollReadOnlyFeedback","resolveSubmissionTarget","ensureAuthenticated","resolveTender","resolveLot","openSubmissionArea","inspectRequiredFields","inspectRequiredDocuments","mapBidPackage","uploadDocuments","fillPriceFields","fillPortalFields","validatePortalState","runPreflight","submit","captureReceipt","resumeAfterReauth"]);
