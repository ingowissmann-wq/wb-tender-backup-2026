...
<details class="panel calc-technical"><summary>Revisionsnachweise</summary>${calcFacts(
  ...
  function portalCards(p) {
    ...
    if (!access) return "";
    const labels = { NOT_CONFIGURED:"Kein Portalzugang hinterlegt", CONFIGURED_UNVERIFIED:"Zugang gespeichert, noch nicht verifiziert", VALIDATION_PENDING:"Zugangsprüfung läuft", VALID:"Gültiger Portalzugang vorhanden", EXPIRED:"Portalzugang oder Sitzung abgelaufen", MFA_REQUIRED:"MFA-Bestätigung erforderlich", CAPTCHA_OR_USER_ACTION_REQUIRED:"Fortsetzung im Portal erforderlich", INVALID:"Portalzugang ungültig", LOCKED:"Portalzugang gesperrt", PORTAL_UNAVAILABLE:"Portal vorübergehend nicht erreichbar" },
