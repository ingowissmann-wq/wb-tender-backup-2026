...
SELECT pg_advisory_xact_lock(hashtextextended('wb-tender:public-document-production-validated-scope:147',0));
...
INSERT INTO tender.audit_events(action,metadata) VALUES('PUBLIC_DOCUMENT_PRODUCTION_VALIDATED_SCOPE_INSTALLED',jsonb_build_object(
  'release','20260826-public-document-production-validated-scope-147.1',
  'acceptedReadMaturity',jsonb_build_array('VALIDATED','VALIDATED_READ_ONLY','PRODUCTION_VALIDATED'),
  'loginBypass',false,'submissionBypass',false,'externalWrite',false,'externalSubmission',false,'transmitted',false));
INSERT INTO app.schema_migrations(version,description) VALUES('0147-public-document-production-validated-scope',
  'Keep credentialless public reads valid after verified document evidence promotes adapter maturity')
