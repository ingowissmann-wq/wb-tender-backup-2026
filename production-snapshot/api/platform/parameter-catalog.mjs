...
}),...securityCostParameters,...cleaningPerformanceParameters]);
if(parameterCatalog.length!==54||new Set(parameterCatalog.map(x=>x.key)).size!==54)throw new Error("parameter_catalog_must_contain_54_unique_keys");
