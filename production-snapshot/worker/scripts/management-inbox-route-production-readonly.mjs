...
const diagnosticStatementTimeout=process.env.MANAGEMENT_INBOX_EXPLAIN_ANALYZE==="true"?120000:30000;
const rawPool=new pg.Pool({connectionString,max:4,options:`-c default_transaction_read_only=on -c statement_timeout=${diagnosticStatementTimeout} -c lock_timeout=3000`});
