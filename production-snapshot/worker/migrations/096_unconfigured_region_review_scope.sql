...
JOIN tender.region_evaluations evaluation ON evaluation.company_id=scope.company_id
 AND evaluation.configuration_version_id IS NOT DISTINCT FROM active.version_id
