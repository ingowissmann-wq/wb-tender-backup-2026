...
SQL
for migration in migrations/155_autopilot_overview_latest_lookup.sql migrations/156_approved_tender_commercial_plans.sql migrations/157_release_auth_and_commercial_enforcement.sql migrations/158_tender_login_challenge_runtime_grants.sql migrations/159_runtime_request_scope.sql; do
