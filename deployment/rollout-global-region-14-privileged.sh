...
printf '%s\n' 'WB_GLOBAL_REGION_ROLLOUT_14=STARTED'

CANDIDATE='wb-tender:global-selected-lot-region-candidate.14'
CANDIDATE_ID='sha256:c89fe70f16e5bb0ba68b33337ed52794abf5bb99db33dea98c6f309647f20d1b'
SOURCE_COMMIT='e82ea69a015eadda56289f8bd6aeedee21d05f25'
...
ROLLBACK_TAG="wb-tender:rollback-global-region-14-${DEPLOYMENT_ID}"
ROLLOUT_OVERRIDE="${BACKUP_DIR}/candidate-14-${DEPLOYMENT_ID}.override.yml"
ROLLBACK_OVERRIDE="${BACKUP_DIR}/rollback-14-${DEPLOYMENT_ID}.override.yml"
...
printf '%s\n' 'WB_PRIVILEGED_GLOBAL_REGION_ROLLOUT_14=SUCCESS'
printf 'production_image=%s\n' "${CANDIDATE_ID}"
printf 'source_commit=%s\n' "${SOURCE_COMMIT}"
printf '%s\n' 'cleaning=128|128|0'
